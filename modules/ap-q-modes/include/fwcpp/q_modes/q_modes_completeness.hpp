...
inline constexpr QModesPortItem kQModesCompleteness[] = {
    ...
    {"QStabilize update / stick scaling", PortStatus::kThisSlice, "mode_qstabilize.hpp qstabilize_update"},
    {"set_limited_roll_pitch helpers", PortStatus::kThisSlice, "set_limited_roll_pitch"},
    {"set_tailsitter_roll_pitch", PortStatus::kThisSlice, "set_tailsitter_roll_pitch"},
    ...
    {"QHover update delegate", PortStatus::kThisSlice, "qhover_update delegate"},
    {"pos_control D limits on enter", PortStatus::kThisSlice, "qhover_enter_apply_d_limits"},
    ...
    {"QAcro update att_target euler", PortStatus::kThisSlice, "qacro_update att_target"},
