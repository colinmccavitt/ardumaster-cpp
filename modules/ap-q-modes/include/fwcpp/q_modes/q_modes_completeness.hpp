...
inline constexpr QModesPortItem kQModesCompleteness[] = {
    ...
    {"hold_stabilize + pilot throttle", PortStatus::kRemaining, "QuadPlane hold_stabilize"},
    {"ESC calibration run body", PortStatus::kRemaining, "run_esc_calibration path"},
    ...
    {"hold_hover + climb rate", PortStatus::kRemaining, "get_pilot_desired_climb_rate_cms"},
    {"assist recovery + spin output", PortStatus::kRemaining, "VTOL_Assist in QHOVER run"},
    {"QAcro update att_target euler", PortStatus::kRemaining, "mode_qacro.cpp update()"},
    {"acro_locking rate input variant", PortStatus::kRemaining, "input_rate_bf_*_3_cds vs _2_cds"},
    {"FW stabilize / rudder output", PortStatus::kRemaining, "stabilize_roll pitch rudder"},
    {"assign_tilt_to_fwd_thr", PortStatus::kRemaining, "tilt rotor mix hook"},
