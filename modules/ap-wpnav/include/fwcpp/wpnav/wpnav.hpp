...
// first slice. Rust spec: ports/plane-fw-rust/crates/ap-wpnav/src/wpnav.rs.
//
// THIS SLICE (testable):
...
//   set_wp_destination_* (NED/NEU/Location), set_spline_destination_* ,
//     set_wp_destination_next_*, force_stop_at_next_wp
//   update_wpnav, advance_wp_target_along_track, update_track_with_speed_accel_limits
//   set_speed_NE/up/down_*, pause/resume, terrain get_terrain_* / rangefinder
//   get_vector_NED from Location, stopping-point wrappers, get_wp_acceleration_cnr
...
//
// Parity tests still to port (Rust): set_wp_destination.rs, update_wpnav.rs,
// advance_wp_target.rs, set_spline_*.rs, wpnav_leftover.rs
//
