...
inline constexpr QAutotunePortItem kQAutotuneCompleteness[] = {
    ...
    {"QAutoTune::init_internals wiring", PortStatus::kRemaining, "AC_AutoTune_Multi body"},
    {"QAutoTune::run autotune FSM", PortStatus::kRemaining, "AC_AutoTune_Multi"},
    {"QAutoTune::stop cleanup", PortStatus::kRemaining, "AC_AutoTune_Multi"},
    {"QAutoTune::log_pids", PortStatus::kRemaining, "qautotune.cpp HAL_LOGGING"},
