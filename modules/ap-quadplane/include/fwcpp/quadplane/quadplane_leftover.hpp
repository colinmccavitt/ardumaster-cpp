...
inline constexpr QuadPlanePortItem kQuadPlaneCompleteness[] = {
    ...
    {"get_singleton", PortStatus::kOutOfScope, "ADR-0012 no singleton; no in-ticket caller"},
    {"AP_Param var_info", PortStatus::kOutOfScope, "ADR-0012 inject params via setters"},
    ...
    {"hold_stabilize / run_z_controller / multicopter_attitude_rate_update", PortStatus::kThisSlice,
     "quadplane_stabilize.hpp ticks; D_* flags; no ap-poscontrol link"},
    {"run_xy_controller / set_climb_rate_ms / assign_tilt_to_fwd_thr", PortStatus::kThisSlice,
     "quadplane_xy_controller.hpp ticks; NE_* flags; no ap-poscontrol link"},
    {"update_throttle_hover / update_throttle_suppression / update_throttle_mix", PortStatus::kThisSlice,
     "quadplane_throttle.hpp ticks; is_flying_vtol injected; no motors/pos/att/SRV"},
    {"HAL_GYROFFT", PortStatus::kOutOfScope, "gyro_fft.update_freq_hover skipped"},
    {"guided_start / guided_update / do_user_takeoff", PortStatus::kThisSlice,
     "quadplane_guided.hpp ticks; no GCS; is_flying injected"},
    {"landing_descent_rate_ms / abort_landing / update_land_positioning", PortStatus::kThisSlice,
