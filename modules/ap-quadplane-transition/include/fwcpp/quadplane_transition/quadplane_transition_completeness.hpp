...
inline constexpr QuadplaneTransitionPortItem kQuadplaneTransitionCompleteness[] = {
    ...
    {"set_state / restart / force complete stubs", PortStatus::kThisSlice,
     "SltTransition slice-1 scaffold"},
    {"completeness catalog", PortStatus::kThisSlice, "this table"},
    {"update_airspeed_wait", PortStatus::kRemaining,
     "AIRSPEED_WAIT timing + assist gate"},
    {"update_timer / Q_TRANSITION_MS dwell", PortStatus::kRemaining,
     "TIMER completion vs tilt_fwd_complete"},
    {"apply_transition_fail / Q_TRANS_FAIL", PortStatus::kRemaining,
     "fail timer + Q* fallback"},
