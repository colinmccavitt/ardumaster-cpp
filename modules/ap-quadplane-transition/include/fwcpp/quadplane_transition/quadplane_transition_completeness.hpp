...
inline constexpr QuadplaneTransitionPortItem kQuadplaneTransitionCompleteness[] = {
    ...
    {"Transition base-class virtuals", PortStatus::kThisSlice,
     "transition_base.hpp roll/pitch/yaw/throttle mix"},
    {"SLT_Transition::update loop", PortStatus::kThisSlice,
     "transition_update_loop.hpp synthetic airspeed + motor wiring"},
