...
// (Copter.cpp / Copter.h / system.cpp). Slice 50 lands
// init_ardupilot leftover through leftover leftover_esc_cal_passthrough_would_loop
...
inline constexpr CopterPortItem kCopterCompleteness[] = {
    ...
    {"Copter::init_ardupilot", PortStatus::kThisSlice,
     "init_ardupilot.hpp; leftover leftover through leftover leftover_esc_cal_passthrough_would_loop leftover leftover flag; leftover leftover_auto leftover leftover_body leftover leftover remaining"},
    {"Copter::init_ardupilot rest", PortStatus::kRemaining,
     "ESC cal auto body remaining"},
