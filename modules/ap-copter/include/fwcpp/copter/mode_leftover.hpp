...
inline constexpr ModePortItem kModeCompleteness[] = {
    ...
    {"ModeRTL::run", ModePortStatus::kThisSlice,
     ...
     "INITIAL_CLIMB leftover leftover_return_start + RETURN_HOME leftover leftover_loiterathome_start; leftover leftover_land_start / leftover leftover_climb_return_run remaining"},
