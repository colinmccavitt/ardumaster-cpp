...
// velocity / climb-rate stay leftover (see leftover catalog below).
...
inline constexpr PortItem kCompleteness[] = {
    ...
    {"get_pilot_desired_lean_angles", PortStatus::kThisSlice,
     "mode.cpp ~558-569; zeros if !has_valid_input"},
    {"get_pilot_desired_yaw_rate", PortStatus::kThisSlice,
     "mode.cpp ~1065-1076; radians(rate)*input_expo"},
    {"get_pilot_desired_throttle", PortStatus::kThisSlice,
     "mode.cpp ~968-992; mid_stick 500; expo cubic"},
    {"rc_input_to_roll_pitch_rad", PortStatus::kThisSlice, "AP_Math/control.cpp ~806-826"},
    {"input_expo", PortStatus::kThisSlice, "AP_Math/control.cpp ~760-770"},
    {"set_accel_throttle_I", PortStatus::kThisSlice,
    ...
    {"get_pilot_desired_climb_rate", PortStatus::kRemaining, "mode.cpp ~1083"},
};
