...
inline constexpr QrtlPortItem kQrtlCompleteness[] = {
    ...
    {"run tailsitter FW branch", PortStatus::kRemaining, "Mode::run pull-up"},
    {"run climb tick", PortStatus::kRemaining, "SubMode::climb XY+Z"},
    {"run RTL vtol_position_controller", PortStatus::kRemaining, "SubMode::RTL"},
    {"run land handoff verify_vtol_land", PortStatus::kRemaining, "QPOS_POSITION2+"},
